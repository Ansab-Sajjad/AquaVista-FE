      ...
      <Box className="flex h-full w-full flex-1 flex-col justify-between gap-8">
        <Box className="flex flex-1 flex-col gap-4">
          ...
          <Box className="flex flex-col gap-1">
            ...
            <MenuLinkButton to="/applications/ai-chat/recent-chat?item=chat-1" size="medium" className="line-clamp-1">
              <Typography variant="body1" className="line-clamp-1 leading-5">
                Resume/CV reviews and rewrite
              </Typography>
            </MenuLinkButton>
            <MenuLinkButton to="/applications/ai-chat/recent-chat?item=chat-2" size="medium" className="line-clamp-1">
              <Typography variant="body1" className="line-clamp-1 leading-5">
                Inventing recipes from random ingredients
              </Typography>
            </MenuLinkButton>
            <MenuLinkButton to="/applications/ai-chat/recent-chat?item=chat-3" size="medium" className="line-clamp-1">
              <Typography variant="body1" className="line-clamp-1 leading-5">
                Comparing ideologies across european cultures
              </Typography>
            </MenuLinkButton>
            <MenuLinkButton to="/applications/ai-chat/recent-chat?item=chat-4" size="medium" className="line-clamp-1">
              <Typography variant="body1" className="line-clamp-1 leading-5">
                Fan theories and character developments
              </Typography>
            </MenuLinkButton>
            <MenuLinkButton to="/applications/ai-chat/recent-chat?item=chat-5" size="medium" className="line-clamp-1">
              <Typography variant="body1" className="line-clamp-1 leading-5">
                World-building for a fantasy game
              </Typography>
            </MenuLinkButton>
            <MenuLinkButton to="/applications/ai-chat/recent-chat?item=chat-6" size="medium" className="line-clamp-1">
              <Typography variant="body1" className="line-clamp-1 leading-5">
