    ...
    >
      <Box
        className={cn(
          ...
          isDarkMode ? "border-grey-20 bg-blend-darken" : "border-grey-500/20 bg-blend-lighten",
        )}
      >
            ...
            <Grid size={{ xs: 12, md: 4 }} className="text-center">
              <Box className="flex flex-col items-center gap-4">
                ...
                <Box className="flex flex-col gap-2">
                  <Typography variant="h1">2K+ Sales</Typography>
                </Box>
              </Box>
            </Grid>
            <Grid size={{ xs: 12, md: 4 }} className="text-center">
              <Box className="flex flex-col items-center gap-4">
                ...
                <Box className="flex flex-col gap-2">
                  <Typography variant="h1">4.8+ Rating</Typography>
                </Box>
              </Box>
            </Grid>
            <Grid size={{ xs: 12, md: 4 }} className="text-center">
              <Box className="flex flex-col items-center gap-4">
                ...
                <Box className="flex flex-col gap-2">
                  <Typography variant="h1">50+ Reviews</Typography>
                </Box>
              </Box>
            </Grid>
          </Grid>
